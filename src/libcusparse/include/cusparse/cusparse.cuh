...
auto cusparse1(const utils::DeviceCSR<T>& a, const utils::DeviceCSR<T>& b)
    ...
    auto* buffer1 = utils::malloc<utils::Location::Device>(buffer1_size);
    utils::handle_cusparse_error(
        cusparseSpGEMM_workEstimation(handle,
                                      CUSPARSE_OPERATION_NON_TRANSPOSE,
                                      CUSPARSE_OPERATION_NON_TRANSPOSE,
    ...
    auto* buffer2 = utils::malloc<utils::Location::Device>(buffer2_size);
    utils::handle_cusparse_error(cusparseSpGEMM_compute(handle,
                                                        CUSPARSE_OPERATION_NON_TRANSPOSE,
                                                        CUSPARSE_OPERATION_NON_TRANSPOSE,
                                                        &ALPHA,
...
auto cusparse2(const utils::DeviceCSR<T>& a, const utils::DeviceCSR<T>& b)
    ...
    utils::handle_cusparse_error(
        cusparseSpGEMM_estimateMemory(handle,
                                      ...
                                      nullptr,
                                      nullptr));
    SPDLOG_DEBUG("Buffer 3 size is {}", buffer3_size);
    auto* buffer3 = utils::malloc<utils::Location::Device>(buffer3_size);
    size_t buffer2_size{};
    utils::handle_cusparse_error(
        cusparseSpGEMM_estimateMemory(handle,
                                      CUSPARSE_OPERATION_NON_TRANSPOSE,
                                      ...
                                      buffer3,
                                      &buffer2_size));
    utils::free<utils::Location::Device>(buffer3);
